...
const LIST_SOURCES_TOOL: Tool = {
  ...
  description:
    ...
    'including the Nemzeti Jogszabálytár (National Legislation Database) (Hungarian Government, Office of Parliamentary Counsel). ' +
...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    description:
      ...
      'Poland is not an EU member but Hungarian laws may reference EU directives/regulations ' +
