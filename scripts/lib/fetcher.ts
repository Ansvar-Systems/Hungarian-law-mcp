/**
 * Rate-limited HTTP client for Hungarian legislation from the Sejm ELI API.
 *
...
const USER_AGENT = 'Hungarian-Law-MCP/1.0 (https://github.com/Ansvar-Systems/hungarian-law-mcp; hello@ansvar.ai)';
