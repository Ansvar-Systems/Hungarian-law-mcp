...
=======
- **No Attorney-Client Relationship**: Use of this Tool does not create an attorney-client relationship (ügyvéd–megbízó jogviszony)
>>>>>>> origin/dev
...
=======
- **Malpractice Risk**: Relying on unverified information from this Tool in professional legal work may constitute professional malpractice (szakmai gondatlanság)
- **Professional Obligations**: You remain solely responsible for verifying all citations, statutes, and legal positions before advising clients or filing documents
- **Professional Rules**: Members of the Hungarian Bar Association (Magyar Ügyvédi Kamara — MÜK) must comply with applicable professional conduct rules (ügyvédi etikai szabályzat) when using AI tools
...
=======
1. Checking the official source (njt.hu — Nemzeti Jogszabálytár, the National Law Register)
2. Verifying the provision is currently in force (hatályos) and has not been amended (módosított) or repealed (hatályon kívül helyezett)
3. Reading the full context of cited provisions
4. Consulting case law (bírói gyakorlat, joggyakorlat) and explanatory materials (törvényindokolás, miniszteri indokolás) for interpretation
...
=======
These services provide editorial oversight, comprehensive annotations (kommentárok), and professional-grade currency guarantees that this Tool **cannot** provide.
>>>>>>> origin/dev
...
=======
- Hungarian law changes continuously through new acts (törvények), government decrees (kormányrendeletek), amendments (módosítások), and court decisions (bírósági döntések)
>>>>>>> origin/dev
...
=======
- Always check official sources for the current legal position (hatályos jogi helyzet)
>>>>>>> origin/dev
...
=======
1. **Complete case law** — Coverage of Kúria (Supreme Court), Alkotmánybíróság (Constitutional Court), ítélőtáblák (Courts of Appeal), and lower court decisions is limited; do not rely solely on this for case law research (bírói gyakorlat kutatása)
2. **Historical statute versions** — Limited availability of historical provision wording (korábbi szövegváltozatok)
3. **Legal commentary** — No editorial annotations (kommentárok), academic commentary (jogirodalom), or practice guides
4. **Unpublished decisions** — Lower court decisions and administrative rulings (határozatok) largely absent
5. **Full legislative history** — Limited coverage of parliamentary materials (országgyűlési irományok, miniszteri indokolások, képviselői felszólalások)
>>>>>>> origin/dev
...
=======
- **Context Missing**: Without commentary (kommentár) and legislative materials, interpretation may be incorrect
...
=======
  - Professional malpractice claims (szakmai gondatlanság miatti igények)
  - Lost cases or adverse judgments
  - Client harm from erroneous advice
  - Regulatory sanctions from bar authorities (fegyelmi eljárás)
>>>>>>> origin/dev
  - Reputational damage
...
=======
- **Sensitive Matters**: For privileged legal matters (ügyvédi titoktartási kötelezettség), consider on-premise deployment
>>>>>>> origin/dev
...
- Provide competent representation (gondos és szakszerű képviselet)
>>>>>>> origin/dev
...
=======
2. **Official Verification**: Cross-check ALL results with official sources (njt.hu)
3. **Commercial Databases**: Use professional legal databases (Complex, Jogtár) for authoritative, annotated versions
...
6. **Update Check**: Before finalizing legal work, check for recent amendments in the Magyar Közlöny
>>>>>>> origin/dev
...
=======
- **ALWAYS VERIFY** all legal information with official sources (njt.hu)
- **NEVER RELY** on this Tool as sole basis for legal advice or professional work
- **UNDERSTAND** this is a research aid, not a substitute for professional legal databases
- **ACKNOWLEDGE** data may be incomplete, outdated, or incorrect
- **COMPLY** with Magyar Ügyvédi Kamara (MÜK) professional ethics rules regarding AI tool use and client confidentiality
>>>>>>> origin/dev
